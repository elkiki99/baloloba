    ...
    <div class="min-h-screen">
        <div class="pt-12 bg-gradient-to-b from-white via-yellow-300 to-white">
            <div class="px-0 mx-auto space-y-6 sm:mt-10 max-w-7xl lg:px-8">
                ...
                <!-- Paquetes -->
                <section class="px-4 py-16 sm:px-4" x-data="{ isExtended: $el.querySelector('#checkbox').checked }">
                    ...
                    <div class="flex flex-col items-center justify-center gap-4 py-5 sm:flex-row sm:gap-6">
                        <!-- Label básico -->
                        <label class="text-sm text-gray-500 min-w-[3rem] text-center sm:me-3">
                            Básico
                        </label>
                        ...
                        <!-- Label extendido -->
                        <label class="relative text-sm text-gray-500 min-w-[4rem] text-center sm:ms-3">
                            Extendido
                    ...
                    <div class="md:space-x-6 md:flex ">
                        ...
                        <div class="max-w-[500px] mx-auto flex flex-col my-10 p-6 text-center transition transform md:scale-110 bg-gray-950 border rounded-lg shadow-lg md:w-1/3 hover:scale-[1.12]"
                            x-data="{
                        ...
                        <!-- Fashion -->
                        <div class="w-full flex-col flex my-10 p-6 text-center transition bg-gray-100 border rounded-lg shadow-lg md:w-1/3 md:hover:scale-[1.02]"
                            x-data="{
                ...
                <!-- Contacto -->
                <section class="mx-auto sm:px-4 md:px-6 lg:px-0 space-y-6 pb-[20vh] max-w-7xl">
                    <h1
                        class="px-4 text-5xl text-transparent md:text-7xl bg-clip-text bg-gradient-to-r from-black to-gray-800">
