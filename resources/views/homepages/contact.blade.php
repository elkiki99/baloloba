    ...
    <div class="min-h-screen">
        <div class="pt-12">
            <div class="space-y-6 sm:mt-10">
                <!-- Text header -->
                <div class="px-4 mx-auto sm:px-6 md:px-8 lg:px-8 max-w-7xl">
                    <h1
                        class="pt-10 text-4xl text-transparent sm:text-5xl md:text-7xl lg:text-8xl bg-clip-text bg-gradient-to-r from-black to-gray-800">
