<x-admin-panel-layout>
    <section class="pb-[20vh] pt-[12vh] sm:px-6 lg:px-8 px-4">
        <div class="space-y-6 md:mx-auto max-w-7xl">
            <h1 class="text-5xl font-bold underline md:text-7xl decoration-yellow-500">Editar headers</h1>
            ...
            <nav class="flex justify-between px-3.5 py-1 rounded-md">
                <ol
                    ...
                    <li><a wire:navigate href="{{ route('headers.index') }}" class="py-1 hover:text-neutral-900">
                            <p
                                class="inline-flex items-center py-1 font-normal hover:text-neutral-900 focus:outline-none">
                                Headers</p>
                    </li></a>
            ...
            <div
                ...
                <header>
                    ...
                    <p class="mt-1 text-sm text-gray-700">
                        {{ __('Edita los datos del header.') }}
                    </p>
                </header>

                <!-- Header form -->
                <livewire:headers.edit :id="$header->id" />
