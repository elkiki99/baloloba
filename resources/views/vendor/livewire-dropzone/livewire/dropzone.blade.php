...
>
    <div class="dz-flex dz-flex-col dz-items-start dz-h-full dz-w-full dz-justify-center dz-bg-transparent dark:dz-bg-gray-800 dark:dz-border-gray-600 dark:hover:dz-border-gray-500">
        @if(! is_null($error))
        ...
        <div @click="$refs.input.click()" class="dz-border dz-border-dashed dz-rounded dz-border-gray-500 dz-w-full dz-cursor-pointer">
            <div>
                <div x-show="!isDragging" class="dz-flex dz-items-center dz-bg-gray-50 dz-justify-center dz-gap-3 dz-py-8 dz-h-full dark:dz-bg-gray-700">
                    ...
                    <p class="dz-text-md dz-text-gray-600 dark:dz-text-gray-400">Arrastra hasta aquí o <span class="dz-font-semibold dz-text-black dark:dz-text-white">Busca archivos</span></p>
                </div>
