...
<aside class="flex sticky top-0 flex-col space-y-6 pb-[20vh] pt-[12vh]">
    ...
    <!-- Client Photoshoots -->
    <a wire:navigate href="{{ route('client.photoshoots') }}" wire:current.strict='text-yellow-600 font-black'
        class="flex items-center gap-2 hover:blur-xs">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="opacity-50 size-6">
    ...
    <!-- Profile -->
    <a wire:current.strict='text-yellow-600 font-black' wire:navigate href="{{ route('profile') }}"
        class="flex items-center gap-2 hover:blur-xs">
