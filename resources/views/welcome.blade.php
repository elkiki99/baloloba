<x-app-layout>
    ...
    <div class="flex flex-col space-y-32">
        ...
        <div class="flex flex-col items-start justify-center w-full min-h-screen bg-center bg-cover"
            style="background-image: url('{{ asset('estudio.jpg') }}'); background-position: top;">
            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="relative w-full min-h-screen bg-center bg-cover"
                    ...
                    <div class="flex flex-col items-start justify-start h-full p-6 space-y-6">
                        <h2 class="max-w-sm text-2xl text-white">
        ...
        <!-- Contact -->
        <div class="min-h-screen mt-12 pb-[20vh] space-y-6">
            <div class="mx-auto space-y-6 max-w-7xl">
                <h1 class="font-bold text-9xl">CONTACTO</h1>

                <div class=" dark:bg-gray-800">
                    <div class="max-w-xl p-8 bg-gradient-to-br from-black via-gray-900 to-black sm:rounded-md">
                        <section>
                            <header>
                                ...
                                <p class="mt-1 text-sm text-gray-200 dark:text-gray-400">
                            ...
                            <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
                                <div>
                                    <x-input-label class="text-gray-200" for="name" :value="__('Nombre')" />
                                ...
                                <div>
                                    <x-input-label class="text-gray-200" for="phone" :value="__('Teléfono')" />
                                ...
                                <div>
                                    <x-input-label class="text-gray-200" for="message" :value="__('Tu consulta')" />
                                    <textarea 
                                        wire:model="message" 
                                        id="message" 
                                        name="message" 
