<x-admin-panel-layout>
    <section class="pb-[20vh] pt-[12vh] sm:px-6 lg:px-8 px-4">
        <div class="space-y-6 md:mx-auto max-w-7xl">
            <h1 class="text-5xl font-bold underline md:text-7xl decoration-yellow-500">Listado de photoshoots</h1>
            ...
            <div class="flex items-center justify-between">
                ...
                <nav class="flex justify-between px-3.5 py-1 rounded-md">
                    <ol
                        ...
                        <li class="flex items-center h-full"><a wire:navigate href="{{ route('panel') }}"
                                class="py-1 hover:text-neutral-900"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <a wire:navigate href="{{ route('photoshoot.create') }}" class="flex items-center gap-2 text-gray-500 hover:text-gray-700">
                    <p class="text-sm">Crear photoshoot</p>
