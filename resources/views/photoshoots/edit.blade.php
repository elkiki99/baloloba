<x-admin-panel-layout>
    <section class="pt-12 pb-[20vh] sm:px-6 lg:px-8 px-0">
        <div class="space-y-6 md:mx-auto sm:mt-10 max-w-7xl">
            <h1 class="text-5xl font-bold underline md:text-7xl decoration-yellow-500">Editar photoshoot</h1>
            ...
            <nav class="flex justify-between px-3.5 py-1 rounded-md">
                <ol
                    ...
                    <li><a wire:navigate href="{{ route('photoshoot.index') }}" class="py-1 hover:text-neutral-900">
                            <p
                    ...
                    <li>
                        <p
                            class="inline-flex items-center py-1 font-normal text-gray-900 hover:text-neutral-800 focus:outline-none">
                            Editar</p>
                    </li>
                </ol>
            </nav>
                ...
                <div
                    ...
                    <header>
                        <div class="flex justify-between">
                            ...
                            <a wire:navigate class="flex gap-2 text-gray-700 hover:blur-xs" href="{{ route('photoshoot.show', $photoshoot->slug) }}">
                                <p>Ver</p>
